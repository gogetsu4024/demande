    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ action('ProjetsController@update',$projet->id) }}">
                        <div class="form-body">
                            @method('PUT')
                            {!! csrf_field() !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="select" name="clientId" class="form-control custom-select">
                                        ...
                                        @foreach($clients as $row)
                                            @if ($projet->clientId==$row->id)
                                                <option selected value="{{$row->id}}">{{$row->nom}} @inc</option>
                                                @else
                            ...
                            <div class="row p-t-20">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$projet->nom}}" type="text" name="nom" id="nomClient" class="form-control" placeholder="John doe">
                            ...
                            <div class="row p-t-20">
                                <div class="col-md-7">
                                    ...
                                    <textarea name="description" id="ck-editor" >{!! $projet->description !!}</textarea>
                                </div>
                                <!--/span-->
                                <!--/span-->
                            </div>
