    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST"  action="{{ action('MissionsController@update',$mission->id) }}">
                        <div class="form-body">
                            @method('PUT')
                            {!! csrf_field() !!}
                            ...
                            <div class="row p-t-20">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$mission->nom}}" type="text" name="nom" id="nomClient" class="form-control" placeholder="John doe">
                            ...
                            <div class="row p-t-20">
                                <div class="col-md-7">
                                    ...
                                    <textarea id="ck-editor" name="description" >{!! $mission->description !!}</textarea>
                                </div>
                                <!--/span-->
                                <!--/span-->
                            </div>
