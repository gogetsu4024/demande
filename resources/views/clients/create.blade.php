                            ...
                            <div class="row p-t-20">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" id="emailClient" class="form-control" placeholder="John doe">
                                        <small class="form-control-feedback"> This is inline help </small> </div>
                                </div>
                                <!--/span-->
                                <!--/span-->
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="Tel" id="numTel" class="form-control" placeholder="John doe">
                                        <small class="form-control-feedback"> This is inline help </small> </div>
                                </div>
                                <!--/span-->
                                <!--/span-->
