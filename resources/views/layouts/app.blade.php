        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li> <a class="waves-effect waves-dark" href="{{route('calendrier.index')}}" aria-expanded="false"><i class="ti-agenda"></i><span class="hide-menu">Calendrier</span></a></li>
                    <li> <a class="waves-effect waves-dark" href="{{route('clients.index')}}" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Clients</span></a></li>
                    <li> <a class="waves-effect waves-dark" href="{{route('projets.index')}}" aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">Projets</span></a></li>
                    <li> <a class="waves-effect waves-dark" href="{{route('missions.index')}}" aria-expanded="false"><i class="ti-email"></i><span class="hide-menu">Sites</span></a></li>
                    <li> <a class="waves-effect waves-dark" href="{{route('missions.index')}}" aria-expanded="false"><i class="ti-palette"></i><span class="hide-menu">Missions</span></a></li>
                    ...
                    <li> <a class="waves-effect waves-dark" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" aria-expanded="false"><i class="fa fa-circle-o text-success"></i><span class="hide-menu">Log Out</span></a></li>
